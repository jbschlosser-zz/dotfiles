...
(custom-theme-set-faces
 ...
 '(font-lock-comment-face ((t (:foreground "#3387cc" ))))
 ...
 '(font-lock-function-name-face ((t (:foreground "#65b042"))))
 '(font-lock-keyword-face ((t (:foreground "#cc6600"))))
 '(font-lock-preprocessor-face ((t (:foreground "#aeaeae"))))
 '(font-lock-reference-face ((t (:foreground "#8b98ab"))))
 ;'(font-lock-string-face ((t (:foreground "#ff355d"))))
 '(font-lock-string-face ((t (:foreground "#ff8080"))))
